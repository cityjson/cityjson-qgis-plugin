...
## Key Updates:
- **New Feature(s)**: The "load semantic surface" option now supports custom semantic surface attributes. This is compatible with the custom attributes generated by my fork of **3DBM** (https://github.com/FLeroux23/3d-building-metrics/tree/main)
___
