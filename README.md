# This fork of **cityjson-qgis-plugin** includes a new feature for enhanced compatibility

## Key Updates:
- **New Feature(s)**: The "load semantic surface" option now supports custom semantic surface attributes, ensuring seamless integration with custom attributes generated by my fork of **3DBM** (https://github.com/FLeroux23/3d-building-metrics/tree/main)
___
